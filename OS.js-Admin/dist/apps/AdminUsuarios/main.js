...
var register = function (core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    iframe.src = 'http://localhost:5173/os/admin/usuarios?token=' + token;
...
module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"AdminUsuarios\",\"icon\":\"icon.png\",\"category\":null,\"server\":null,\"title\":{\"en_EN\":\"Usuarios\"},\"description\":{\"en_EN\":\"Usuarios\"},\"files\":[\"main.js\"]}");
...
module.exports = __webpack_require__(/*! C:\Users\xoryex\Desktop\Proyecto_Escuela\OS.js-Admin\src\packages\AdminUsuarios\index.js */"./index.js");
