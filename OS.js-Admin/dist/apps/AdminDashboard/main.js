...
module.exports = /*#__PURE__*/JSON.parse('{"type":"application","name":"AdminDashboard","icon":"icon.png","category":null,"server":null,"title":{"en_EN":"Dashboard"},"description":{"en_EN":"Dashboard"},"files":["main.js"]}');
...
var register = function (core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    iframe.src = 'http://localhost:5173/os/admin/dashboard?token=' + token;
