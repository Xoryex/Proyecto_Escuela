...
var register = function (core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    iframe.src = 'http://localhost:5173/os/admin/roles?token=' + token;
...
module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"AdminRoles\",\"icon\":\"icon.png\",\"category\":null,\"server\":null,\"title\":{\"en_EN\":\"Roles\"},\"description\":{\"en_EN\":\"Roles\"},\"files\":[\"main.js\"]}");
...
module.exports = __webpack_require__(/*! C:\Users\xoryex\Desktop\Proyecto_Escuela\OS.js-Admin\src\packages\AdminRoles\index.js */"./index.js");
