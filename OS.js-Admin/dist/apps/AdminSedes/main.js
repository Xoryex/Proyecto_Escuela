...
var register = function (core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    iframe.src = 'http://localhost:5173/os/admin/sedes?token=' + token;
...
module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"AdminSedes\",\"icon\":\"icon.png\",\"category\":null,\"server\":null,\"title\":{\"en_EN\":\"Sedes\"},\"description\":{\"en_EN\":\"Sedes\"},\"files\":[\"main.js\"]}");
...
module.exports = __webpack_require__(/*! C:\Users\xoryex\Desktop\Proyecto_Escuela\OS.js-Admin\src\packages\AdminSedes\index.js */"./index.js");
