...
var register = function (core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    iframe.src = 'http://localhost:5173/os/admin/suscripciones?token=' + token;
...
/*!***********************!*\
  !*** ./metadata.json ***!
  \***********************/
/*! exports provided: type, name, icon, category, server, title, description, files, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"AdminSuscripciones\",\"icon\":\"icon.png\",\"category\":null,\"server\":null,\"title\":{\"en_EN\":\"Suscripciones\"},\"description\":{\"en_EN\":\"Suscripciones\"},\"files\":[\"main.js\"]}");
...
module.exports = __webpack_require__(/*! C:\Users\xoryex\Desktop\Proyecto_Escuela\OS.js-Admin\src\packages\AdminSuscripciones\index.js */"./index.js");
